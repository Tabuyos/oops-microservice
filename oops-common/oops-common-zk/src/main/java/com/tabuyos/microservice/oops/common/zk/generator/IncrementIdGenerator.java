package com.tabuyos.microservice.oops.common.zk.generator;
 ...
 *   <b>package: </b><i>com.tabuyos.microservice.oops.common.zk.generator</i>
 *   <b>class: </b><i>IncrementIdGenerator</i>
 *   comment here.
 * </pre>
 *
 * @author
...
public class IncrementIdGenerator implements IdGenerator {
  ...
  public Long nextId() {
    ...
    String path =
        GlobalConstant.ZK_REGISTRY_ID_ROOT_PATH
    ...
    if (regCenter.isExisted(path)) {
      ...
      Integer id =
          regCenter
              .getAtomicValue(GlobalConstant.ZK_REGISTRY_SEQ, new RetryNTimes(2000, 3))
              .postValue();
      // 将数据写入节点
