...
public class RedisKeyUtil {
	 ...
	 */
	private static final String RESET_PWD_TOKEN_KEY = "oops:restPwd";
	private static final String ACTIVE_USER = "oops:activeUser";
	private static final String SEND_SMS_COUNT = "oops:sms:count";
	private static final String SEND_EMAIL_CODE = "oops:email:code";
	private static final String ACCESS_TOKEN = "oops:token:accessToken";
	private static final String UPLOAD_FILE_SIZE = "oops:file:upload_file_size";
