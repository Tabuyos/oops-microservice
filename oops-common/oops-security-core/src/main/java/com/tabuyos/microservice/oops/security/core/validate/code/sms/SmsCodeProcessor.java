...
import com.tabuyos.microservice.oops.security.core.properties.SmsCodeProperties;
 ...
 *     </pre>
 * @version 0.1.0
 * @since 0.1.0 - 3/1/21 5:11 PM
 */
@Component
public class SmsCodeProcessor extends AbstractValidateCodeProcessor<ValidateCode> {
  private final Logger log = LoggerFactory.getLogger(SmsCodeProcessor.class);
